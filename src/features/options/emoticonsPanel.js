    ...
    context.AdditionalFeatureManager.register(function(shoutboxAPI, view) {
        ...
        emoticonPanelBox
            ...
            .html(buildEmoticonsButtons([
                    ...
                    { label: 'Duzy uďż˝miech', file: 'cheesy.gif', code: ';D' },
                    ...
                    { label: 'heart', file: 'heart.gif', code: ':heart:' },
                    { label: 'laugh', file: 'laugh.gif', code: ':laugh:' },
                    { label: 'ninja', file: 'ninja.gif', code: ':ninja:' },
                    { label: 'angel', file: 'angel.gif', code: ':angel:' },
